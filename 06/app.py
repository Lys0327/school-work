...
app = Flask(__name__)
line_bot_api = LineBotApi('kZpY6BYMloi8Hu9FQM6soXWqpFuVD6WGtrBLupUA475fY5b1co8teYr+Vh/rrOMYLz7ckkmqaGBz734rCXPblLwXmBsbasfER6XX6zlDhAvi/dMQnaB7Iu9Mv4ZqS6XXUNcReorjpbRQXS7+WKRECQdB04t89/1O/w1cDnyilFU=')
line_handler = WebhookHandler('fcffbb4f5f439e02204d703d09b515fe')

url ='https://opendata.cwa.gov.tw/api/v1/rest/datastore/F-C0032-001?Authorization=CWA-85E25462-6BC3-4387-B2B0-D420BABEE4B9&format=JSON'
ansA=[]
city=''
